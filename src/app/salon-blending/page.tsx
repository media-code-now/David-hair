    ...
    <>
            ...
            {[
              {
                ...
                desc: 'גזירה מקצועית ויצירת שכבות לשילוב חלק של הטופר או הפאה עם השיער הטבעי שלך. אנחנו מעצבות את הפריט בהתאם למבנה הפנים ולסגנון האישי שלך.',
                icon: '✂️',
      ...
      <ServiceDetailSection
        ...
        benefits={[
          ...
          { title: 'הנחיות טיפול', description: 'לפני שאת יוצאת, אנחנו עוברות איתך על הטיפול הביתי: שטיפה, עיצוב ושמירה על התוצאה בין הפגישות.' },
        ]}
        imagePlaceholder="🪞"
        reversed
      />
