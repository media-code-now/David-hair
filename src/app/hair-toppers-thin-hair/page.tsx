...
export const metadata: Metadata = {
  ...
  description: 'טופרים מותאמים לשיער דליל ושביל מתרחב. כיסוי קל משקל ובלתי נראה שמחזיר נפח באופן טבעי. קביעת ייעוץ התאמה ללא התחייבות.',
  ...
  openGraph: {
    ...
    description: 'טופרים מותאמים לשיער דליל ושביל מתרחב. כיסוי קל ובלתי נראה.',
    type: 'website',
  },
};
...
const faqs = [
  {
    ...
    answer: 'לא. הטופרים שלנו תוכננו במיוחד לשיער דליל ועדין. אנחנו משתמשות בקליפסים עדינים ללא לחץ ובסיסים קלי משקל שלא מושכים ולא מלחיצים את השיער הטבעי שלך. למעשה, הרבה לקוחות מגלות שהכיסוי של האזור הדליל דווקא מגן עליו מפני נזקי סביבה.'
  },
  {
    question: 'כמה קטן יכול להיות טופר רק לאזור השביל?',
    answer: 'אנחנו מציעות טופרים קטנים במידות החל מ-5x8 ס"מ לכיסוי ממוקד של שביל. טופרים מיני אלה יושבים ישירות על השביל המתרחב ומתחברים עם 1-2 קליפסים בלבד. הם כמעט בלתי נראים ולוקח שניות להצמיד אותם.'
  },
  {
  ...
  return (
    <>
      ...
      <ServiceCTA
        ...
        subtitle="שיער דליל לא חייב להגדיר את המראה שלך. קבעי ייעוץ חינם וראי איך טופר מותאם אישית יכול לשנות את הביטחון שלך."
