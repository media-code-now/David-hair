    ...
    <>
      ...
      <main>
        ...
        <ServiceDetailSection
          ...
          description="בחירה נכונה של בסיס משפיעה על המראה, התחושה והעמידות. אנחנו מתאימות את היחידה למבנה הקרקפת, לרגישות העור ולשגרת החיים שלך."
          benefits={[
        ...
        <ServiceCTA
          title="מתלבטת אם פדחת מתאימה לך?"
          subtitle="קבעי ייעוץ אישי ללא התחייבות ונבדוק יחד את סוג הבסיס, הגוון והפתרון המדויק למבנה השיער שלך."
