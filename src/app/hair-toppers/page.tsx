...
export const metadata: Metadata = {
  title: 'טופר שיער לנפח טבעי וכיסוי שביל – David Hair Solutions',
  description: 'טופרי שיער לכיסוי קודקוד ושביל במראה טבעי. קלים, דיסקרטיים, עם התאמה אישית בחדר פרטי. קביעת ייעוץ ללא התחייבות.',
  keywords: 'טופר שיער, טופר לשיער דליל, כיסוי שביל, טופר שיער טבעי, נפח לשיער, hair toppers',
  openGraph: {
    title: 'טופר שיער לנפח טבעי וכיסוי שביל – David Hair',
    description: 'טופרי שיער לכיסוי קודקוד ושביל במראה טבעי. התאמה אישית בחדר פרטי.',
    type: 'website',
  },
};
...
const faqs = [
  ...
  },
  {
    ...
    answer: 'גדלי טופרים משתנים בהתאם לאזור הכיסוי הנדרש. במהלך הייעוץ, אנחנו מודדות את האזור הדליל וממליצות על גודל הבסיס המושלם — מקליפסים קטנים לכיסוי שביל ועד לחתיכות גדולות יותר לאזורים רחבים. אנחנו מוודאות שהבסיס יושב בצורה טבעית על הקרקפת.'
  },
  {
  ...
  },
  {
    ...
    answer: 'עם טיפול נכון, טופר שיער אנושי איכותי מחזיק בדרך כלל 1-2 שנים בשימוש יומיומי. אנחנו מספקות מדריך טיפול מלא ומציעות שירותי תחזוקה כולל שטיפה, מרכך ועיצוב מחדש להארכת חיי הפריט.'
  },
  {
  ...
  return (
    <>
      ...
      <ServiceHero
        ...
        subtitle="טופרים קלים ונושמים שמתחברים לשיער הטבעי שלך לנפח, כיסוי וביטחון מיידי. שיער אנושי 100%, התאמה אישית בסביבה פרטית."
      ...
      <ServiceDetailSection
        ...
        benefits={[
          ...
          { title: 'אפשרויות כיסוי מרובות', description: 'מקליפסים קטנים לכיסוי שביל ועד חתיכות גדולות יותר לאזורים רחבים — אנחנו מתאימות את הגודל המושלם לצרכים שלך.' },
      ...
      <ServiceDetailSection
        ...
        benefits={[
          ...
          { title: 'עיצוב מקצועי', description: 'צוות הסלון שלנו גוזר ומשלב את הטופר עם השיער הטבעי שלך למראה חלק ובלתי ניתן לזיהוי.' },
        ]}
        imagePlaceholder="✨"
        reversed
      />
