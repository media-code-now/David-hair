...
const faqs = [
  ...
  },
  {
    ...
    answer: 'אנחנו מציעות שיער אנושי אירופי, אסייתי ומשולב פרימיום. לכל סוג יש מאפיינים ייחודיים מבחינת מרקם, עובי והתנהגות בעיצוב. במהלך הייעוץ נעזור לך לבחור את סוג השיער המתאים ביותר לשיער הטבעי שלך או למראה הרצוי.'
  },
  {
    ...
    <>
      ...
      <ServiceDetailSection
        ...
        benefits={[
          ...
          { title: 'קו שיער בלתי נראה', description: 'אפשרויות תחרה קדמית ותחרה מלאה יוצרות קו שיער שכמעט בלתי ניתן לזיהוי. עשי שביל בכל מקום ועצבי בכל דרך.' },
      ...
      <ServiceCTA
        ...
        subtitle="הכול מתחיל בשיחה. קבעי ייעוץ חינם ונגשים את החזון שלך — מותאם אלייך בכל פרט."
