...
const faqs = [
  {
    ...
    answer: 'אנחנו מטפלים כמעט בכל סוגי הנזק לפאות ולטופרים: סבכים, נשירת שיער, רשתות שבורות, תחרה קרועה, כיפה מתוחה, צבע דהוי, שיער יבש או פגום, קליפסים שבורים ובעיות מבניות. אם הבסיס שלם, כמעט תמיד נוכל לשקם את הפריט.'
  },
  {
  ...
  },
  {
    ...
    answer: 'כן, אם הפאה עשויה משיער אנושי אמיתי. אנחנו יכולים להכהות, להבהיר (בגבולות), להוסיף הבהרות או לשנות את הצבע לחלוטין. לפאות סינתטיות יש אפשרויות שינוי צבע מוגבלות, שנדון בהן במהלך הבדיקה.'
  },
  {
    question: 'אפשר לשנות את מידת הפאה שלי אם היא כבר לא מתאימה?',
    answer: 'בהחלט. בין אם הפאה נמתחה עם הזמן או שמידת הראש השתנתה, אנחנו יכולים להקטין או להגדיל את הכיפה להתאמה מושלמת. אנחנו גם יכולים להוסיף או להחליף רצועות מתכווננות וגומיות לאבטחה טובה יותר.'
  },
  {
    question: 'אתם מטפלים בפאות שנרכשו במקום אחר?',
    answer: 'כן! אנחנו מטפלים ומתקנים פאות וטופרים ללא קשר למקום הרכישה. לצוות שלנו ניסיון עם כל המותגים וסוגי הבנייה המרכזיים. הביאו את הפריט להערכה חינמית.'
  },
];
  ...
  return (
    <>
      ...
      <ServiceHero
        ...
        subtitle="אל תחליפו — שַקמו. שירותי תיקון, חידוש ושדרוג מקצועיים שמחזירים לפאה או לטופר את החיים."
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              מתיקונים מהירים ועד שיקום מלא — אנחנו מטפלים בהכל
            </p>
          </div>
      ...
      <ServiceDetailSection
        eyebrow="איך זה עובד"
        title="הביאו את הפריט, אנחנו נחזיר אותו לחיים"
        description="תהליך התיקון שלנו פשוט: הביאו את הפריט, קבלו הערכה כנה, ואנחנו נשקם אותו למצב הטוב ביותר שלו."
        benefits={[
          { title: 'הערכה חינמית', description: 'הביאו את הפאה או הטופר להערכה ללא עלות. נגיד בדיוק מה צריך לעשות ומה העלות — ללא הפתעות.' },
          { title: 'המלצה כנה', description: 'אם התיקון לא משתלם, נאמר זאת. אנחנו מעדיפים לזכות באמון ביושר מאשר למכור שירות שלא צריך.' },
      ...
      <ServiceDetailSection
        eyebrow="שדרוגים"
        title="שדרגו את הפריט הקיים שלכם"
        description="אוהבים את הפאה אבל רוצים משהו נוסף? אנחנו יכולים לשדרג פריטים קיימים עם תכונות חדשות, בנייה טובה יותר ושיפורים מודרניים."
        benefits={[
          { title: 'הוספת תחרה קדמית', description: 'שדרוג פאת רשת עם תחרה קדמית קשורה ביד לקו שיער טבעי יותר.' },
          { title: 'כיוונון צפיפות', description: 'עבה מדי? דליל מדי? אנחנו יכולים להוסיף או להוריד שיער כדי להגיע לצפיפות האידיאלית.' },
          { title: 'שינוי סגנון', description: 'שנו את התספורת, הוסיפו שכבות, עדכנו את הצורה — והפכו את הפאה לסגנון חדש לגמרי.' },
          { title: 'שיפורי נוחות', description: 'הוספת בטנות רכות, שדרוג רצועות, שיפור אוורור — והופכים את הפריט הקיים לנוח יותר.' },
        ]}
        imagePlaceholder="⬆️"
        reversed
      />
      ...
      <ServiceCTA
        title="תנו לפריט שלכם חיים חדשים"
        subtitle="הביאו את הפאה או הטופר להערכה חינמית. ניתן הערכה כנה ומחיר שקוף — ללא התחייבות."
