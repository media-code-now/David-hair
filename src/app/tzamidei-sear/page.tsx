  ...
  return (
    <>
      ...
      <main>
        ...
        <HairUnitsCallout unitName="צמיד שיער" />

        <ServiceFAQ faqs={faqs} subtitle="שאלות נפוצות על צמידי שיער ותהליך ההתאמה" />

        <ServiceCTA
          title="רוצים לבדוק אם צמידי שיער מתאימים לכם?"
          subtitle="קבעו ייעוץ אישי ללא התחייבות ונבנה עבורכם פתרון מדויק לנפח, אורך ומראה טבעי."
