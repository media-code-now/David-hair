...
const ALL_FAQS = [
  ...
  {
    q: 'מה זה יחידת שיער וכיפת שיער?',
    a: 'יחידת שיער (Hair Unit) הוא שם כולל לכל פתרונות השיער הלא-כירורגיים – טופר, פדחת, צמיד ופאה בהתאמה אישית – שמטרתם להחזיר נפח, כיסוי ומראה טבעי באזורי דלילות. "כיפת שיער" מתייחסת לבסיס (הכיפה) שעליו נקשר השיער של היחידה, ורבים משתמשים בשני המונחים כמילים נרדפות. אצלנו כל יחידת שיער נבנית בהתאמה אישית מלאה – סוג הכיפה (משי, תחרה או מונופילמנט), הצפיפות והגוון נקבעים לפי מבנה הראש ורמת הדלילות.',
  },
  {
...
const glossaryTerms = [
  {
    name: 'יחידת שיער / כיפת שיער',
    description:
      'שם כולל לפתרונות שיער לא-כירורגיים (טופר, פדחת, צמיד, פאה) המונחים על הראש ומעניקים כיסוי ונפח טבעיים. "כיפת שיער" מתייחסת לבסיס שעליו נקשר השיער; המונחים משמשים לרוב כמילים נרדפות.',
  },
  {
