...
const faqs = [
  ...
  },
  {
    ...
    a: 'זה נדיר, אבל בואי וְדברנו על זה. אנחנו יכולות לעדכן, לשנות את צבע, או לדבר על אפשרויות שונות עד שאתה מרגישה מושלמת.',
  },
  {
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10" dir="rtl">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600" dir="rtl">
            אתה עדיין מתלבטת? בואי נענו לשאלות שכולנו מדברות אנחנו.
          </p>
        </div>
