...
const faqs = [
  ...
  { id: 5, question: 'אפשר לצבוע או לסלסל את השיער?', answer: 'כן! טופרים ופאות משיער טבעי ניתנים לצביעה, החלקה, סלסול ועיצוב בחום – בדיוק כמו שיער רגיל. אנחנו מבצעים את כל הטיפולים האלה בסלון שלנו במקצועיות.' },
  ...
  { id: 9, question: 'מה זה טופר שיער?', answer: 'טופר שיער (Hair Topper) הוא יחידת שיער חלקית המכסה אזור ספציפי של דלדול או נשירה – בדרך כלל הקדקוד, הקו האמצעי או הפדחת. בניגוד לפאה מלאה, הטופר משתלב עם השיער הטבעי הקיים באמצעות קליפסים, ומיועד לנשים עם נשירה חלקית עד בינונית. הוא מעניק נפח, כיסוי ומראה טבעי מלא.' },
  { id: 10, question: 'מה ההבדל בין טופר שיער לפאה?', answer: 'טופר מכסה חלק מהראש (קדקוד, פדחת, שביל) ומשתלב עם השיער הטבעי הקיים. פאה מלאה מכסה את כל הראש ומיועדת לנשירה נרחבת יותר. טופר מתאים לנשירה חלקית עד בינונית; פאה מתאימה לנשירה כוללת או כמעט-כוללת. בייעוץ נקבע יחד איזה פתרון מתאים למצב שלך.' },
  { id: 11, question: 'האם טופר שיער נראה ומרגיש טבעי?', answer: 'כן. טופרים משיער אנושי טבעי (רמי) נראים, זורמים ומרגישים בדיוק כשיער אמיתי. בסיס הלייס או הסילק משתלב עם הקרקפת. עם התאמה מקצועית בסלון – גזירה, צבע ועיצוב – אפ אחד לא יבחין בהבדל.' },
  { id: 12, question: 'איזה פתרון שיער מתאים לנשים אחרי כימותרפיה?', answer: 'לאחר כימותרפיה מומלץ פאה רפואית מלאה משיער אנושי רמי, עם בסיס רך וגמיש שלא מגרה את הקרקפת הרגישה. אנחנו מתמחחות בהתאמה מלאה לנשים במצבים רפואיים – בסביבה פרטית, באדיבות ובסבלנות.' },
];
