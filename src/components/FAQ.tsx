...
const faqs = [
  ...
  { id: 2, question: 'כמה זה עולה? יש מחירים משתנים?', answer: 'המחירים משתנים לפי סוג המוצר, איכות השיער, ורמת ההתאמה. טופרים מתחילים מ-₪650, פאות מתחילות מ-₪890. בייעוץ ניתן מחיר מדויק לפי הצורך שלך.' },
  { id: 3, question: 'האם רואים את הקליפסים או את הבסיס?', answer: 'לא. הקליפסים מוסתרים לחלוטין מתחת לשיער, ומותאמים בגודל ובמיקום כך שהם בלתי נראים. גם במגע קשה לזהות אותם. בסיס הלייס או הסילק משתלב בצורה טבעית עם הקרקפת.' },
  ...
  { id: 8, question: 'תוך כמה זמן אקבל את המוצר?', answer: 'התאמה ראשונית מתבצעת בדרך כלל באותו השבוע. אספקה של מוצר מותאם אישית לוקחת בין 2-4 שבועות, תלוי בסוג המוצר ובמפרט שנבחר.' },
];
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12 sm:mb-14">
          ...
          <p className="text-[17px] text-gray-500 max-w-2xl mx-auto mb-8" dir="rtl">
            זה תהליך חדש, ואנחנו מבינות את החששות. הנה התשובות למה שרוב הנשים שואלות.
          </p>
        </div>
