        ...
        <div className="grid md:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="space-y-7">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <a href="https://wa.me/972525550415" className="px-8 py-4 rounded-2xl bg-[#25D366] text-white hover:bg-[#20BA5A] transition-all duration-300 font-semibold text-[17px] text-center active:scale-[0.97]">
                שלחו הודעה בוואטסאפ
              </a>
            </div>
