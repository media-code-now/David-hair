...
const newArrivals = [
  { id: 1, name: 'טופר משי קרקפת טבעית', category: 'חדש במלאי', price: '₪890', rating: 5.0, reviews: 8, isNew: true },
  { id: 2, name: 'פאה גלית דגם חדש', category: 'חדש במלאי', price: '₪1,190', rating: 4.9, reviews: 5, isNew: true },
];

const bestSellers = [
  { id: 3, name: 'טופר בלונד לוקס', category: 'הנמכר ביותר', price: '₪690', rating: 4.9, reviews: 156, isBestSeller: true },
  { id: 4, name: 'פאה רפואית נוחה', category: 'הנמכר ביותר', price: '₪910', rating: 4.9, reviews: 128, isBestSeller: true },
  { id: 5, name: 'טופר משי ערמוני', category: 'הנמכר ביותר', price: '₪730', rating: 4.8, reviews: 142, isBestSeller: true },
  { id: 6, name: 'פאה פלטינום יוקרתית', category: 'פאה מותאמת', price: '₪1,280', rating: 5.0, reviews: 89, isBestSeller: true },
];
  ...
  return (
    <section className="py-16 sm:py-20 lg:py-24 bg-gradient-to-b from-navy-50/20 to-white/60 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="mb-16">
          <div className="mb-8">
            <h3 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2 tracking-tight" dir="rtl">
              חדש במלאי
            </h3>
            <p className="text-[15px] text-gray-500" dir="rtl">
              הדגמים החדשים ביותר שהגיעו אלינו
            </p>
          </div>
          <div className="grid sm:grid-cols-2 gap-5">
            {newArrivals.map((product) => (
              <ProductCard key={product.id} product={product} favorites={favorites} toggleFavorite={toggleFavorite} />
            ))}
          </div>
        </div>
        ...
        <div>
          <div className="mb-8">
            ...
            <p className="text-[15px] text-gray-500" dir="rtl">
              הדגמים המבוקשים והאהובים ביותר על לקוחותינו
            </p>
          </div>
...
function ProductCard({ product, favorites, toggleFavorite }: { product: any; favorites: number[]; toggleFavorite: (id: number) => void }) {
  return (
    <div
